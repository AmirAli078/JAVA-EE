...
style="height: 10px;background-color: #283593"></div>
...
<div class="col-md-6">
 <form class="form-inline my-2 my-lg-0">
    ...
    <a href="register.jsp" class="btn btn-primary"><i class="fa fa-user-plus" aria-hidden="true"></i> Register</a>
</div>
</div>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom ">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0">
      ...
      <button class="btn btn-light my-2 my-sm-0 ml-2" type="submit"><i class="fa-solid fa-address-book"></i> Contact Us</button>
    </form>
  </div>
</nav>