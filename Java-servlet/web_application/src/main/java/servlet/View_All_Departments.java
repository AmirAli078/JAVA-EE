...
/**
 * Servlet implementation class View_All_Departments
 */
@WebServlet("/View_All_Departments")
public class View_All_Departments extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
            ...
            out.println("<th style='padding: 10px;'>DEPT ID</th>");
            ...
            while (rs.next()) {
                ...
                out.println("<th style='padding: 10px;'>" + rs.getString("d_name") + "</th>");
                out.println("<th style='padding: 10px;'>" + rs.getString("d_id") + "</th>");


                out.println("<th style='padding: 10px;'><a href='EditDEpt?d_id=" + rs.getString("d_id") + "' style='text-decoration: none; color: #0074D9;'>Edit</a></th>");
                out.println("<th style='padding: 10px;'><a href='DeleteDept?d_id=" + rs.getString("d_name") + "' style='text-decoration: none; color: #FF4136;'>Delete</a></th>");
